...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mode.mode'
        db.delete_column(u'survey_mode', 'mode')

        # Adding field 'Mode.name'
        db.add_column(u'survey_mode', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Mode.mode'
        db.add_column(u'survey_mode', 'mode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35),
                      keep_default=False)

        # Deleting field 'Mode.name'
        db.delete_column(u'survey_mode', 'name')
