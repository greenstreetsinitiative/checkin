...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Leg.commutersurvey'
        db.add_column(u'survey_leg', 'commutersurvey',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['survey.Commutersurvey']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Leg.commutersurvey'
        db.delete_column(u'survey_leg', 'commutersurvey_id')
    ...
    models = {
        u'survey.commutersurvey': {
            ...
            'legs': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['survey.Leg']",'related_name': "'commutelegs'", 'symmetrical': 'False'}),
