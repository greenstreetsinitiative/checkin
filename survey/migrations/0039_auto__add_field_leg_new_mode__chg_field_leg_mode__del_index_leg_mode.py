...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_leg', 'new_mode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Mode'], null=True, primary_key=False, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'survey_leg', 'id')


        # # Renaming column for 'Leg.mode' to match new field type.
        # db.rename_column(u'survey_leg', 'mode', 'mode_id')
        # Changing field 'Leg.mode'
        db.alter_column(u'survey_leg', 'mode_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['survey.Mode']))
    ...
    models = {
        ...
        u'survey.leg': {
            ...
            'new_mode': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Mode']", 'null': 'True', 'primary_key': True, 'db_column': "'id'", 'blank': 'True'})
        },
        u'survey.mode': {
            'Meta': {'object_name': 'Mode'},
            'carb': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '1', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'met': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '1', 'blank': 'True'}),
