...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commutersurvey.wr_day_month'
        db.add_column(u'survey_commutersurvey', 'wr_day_month',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['survey.Month']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commutersurvey.wr_day_month'
        db.delete_column(u'survey_commutersurvey', 'wr_day_month_id')
