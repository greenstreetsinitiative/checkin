...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Month.open_checkin'
        db.add_column(u'survey_month', 'open_checkin',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Month.close_checkin'
        db.add_column(u'survey_month', 'close_checkin',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Month.open_checkin'
        db.delete_column(u'survey_month', 'open_checkin')

        # Deleting field 'Month.close_checkin'
        db.delete_column(u'survey_month', 'close_checkin')
    ...
    models = {
        ...
        u'survey.month': {
            ...
            'url_month': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'})
        }
    }
