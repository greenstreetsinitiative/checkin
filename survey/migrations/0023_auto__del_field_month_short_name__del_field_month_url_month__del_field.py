...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Month.short_name'
        db.delete_column(u'survey_month', 'short_name')

        # Deleting field 'Month.url_month'
        db.delete_column(u'survey_month', 'url_month')

        # Deleting field 'Month.month'
        db.delete_column(u'survey_month', 'month')


    def backwards(self, orm):
        # Adding field 'Month.short_name'
        db.add_column(u'survey_month', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Month.url_month'
        db.add_column(u'survey_month', 'url_month',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Month.month'
        db.add_column(u'survey_month', 'month',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)
