...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mode.carb'
        db.alter_column(u'survey_mode', 'carb', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Mode.met'
        db.alter_column(u'survey_mode', 'met', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Mode.carb'
        db.alter_column(u'survey_mode', 'carb', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1))

        # Changing field 'Mode.met'
        db.alter_column(u'survey_mode', 'met', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1))
