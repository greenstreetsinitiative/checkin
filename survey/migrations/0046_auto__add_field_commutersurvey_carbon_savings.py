...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commutersurvey.carbon_savings'
        db.add_column(u'survey_commutersurvey', 'carbon_savings',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commutersurvey.carbon_savings'
        db.delete_column(u'survey_commutersurvey', 'carbon_savings')
    ...
    models = {
        u'survey.commutersurvey': {
            ...
            'carbon_savings': ('django.db.models.fields.FloatField', [], {'default': '0.0', 'null': 'True', 'blank': 'True'}),
        ...
        u'survey.employer': {
            ...
            'active2015': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
