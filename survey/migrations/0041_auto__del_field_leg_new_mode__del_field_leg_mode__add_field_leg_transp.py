...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Leg.transport_mode'
        db.add_column(u'survey_leg', 'transport_mode',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Leg.transport_mode'
        db.delete_column(u'survey_leg', 'transport_mode_id')
