...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        mode_map = {
            'c' : 'Driving alone',
            'da' : 'Driving alone',
            'dalt' : 'Driving alone (alternate vehicle)',
            'cp' : 'Carpooling',
            'rai' : 'Commuter rail',
            'sub' : 'Subway',
            'bus' : 'Bus',
        ...
        modeslist = ['c', 'cp', 'da', 'dalt', 'w', 'b', 't', 'o', 'r', 'tc']

        for mode in modeslist:
            new_mode = orm.Mode.objects.filter(mode='mode_map[mode]')
            # new_mode_key = new_mode.pk
            if new_mode.exists():
                legs = orm.Leg.objects.filter(mode=mode)
                legs.update(new_mode_id=new_mode.pk)
                legs.save()
