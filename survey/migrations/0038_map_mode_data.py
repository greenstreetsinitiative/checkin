...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for mode in modeslist:
            # get all surveys with this mode
            surveys = orm.Commutersurvey.objects.filter(leg__mode=mode)
            new_mode = orm.Mode.objects.filter(mode='mode_map[mode]')
            surveys.update(leg__new_mode=new_mode)
    ...
    models = {
        ...
        u'survey.leg': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mode': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Mode']"})
        },
        u'survey.mode': {
