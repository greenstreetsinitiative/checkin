...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_leg', 'mode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Mode'], null=True),
                      keep_default=False)

        # Adding field 'Leg.carbon'
        db.add_column(u'survey_leg', 'carbon',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Leg.calories'
        db.add_column(u'survey_leg', 'calories',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Leg.carbon'
        db.delete_column(u'survey_leg', 'carbon')

        # Deleting field 'Leg.calories'
        db.delete_column(u'survey_leg', 'calories')
    ...
    models = {
        ...
        u'survey.leg': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mode': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Mode']", 'null': 'True'}),
