...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mode.MET'
        db.delete_column(u'survey_mode', 'MET')

        # Deleting field 'Mode.CO2'
        db.delete_column(u'survey_mode', 'CO2')

        # Adding field 'Mode.met'
        db.add_column(u'survey_mode', 'met',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1, blank=True),
                      keep_default=False)

        # Adding field 'Mode.carb'
        db.add_column(u'survey_mode', 'carb',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Mode.CO2'
        db.add_column(u'survey_mode', 'CO2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Mode.carb'
        db.delete_column(u'survey_mode', 'carb')
