...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Month.date'
        db.delete_column(u'survey_month', 'date')


    def backwards(self, orm):
        # Adding field 'Month.date'
        db.add_column(u'survey_month', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 15, 0, 0)),
                      keep_default=False)
