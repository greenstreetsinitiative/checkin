...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Team'
        db.create_table(u'survey_team', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Employer'], null=True, blank=True)),
        ))
        db.send_create_signal(u'survey', ['Team'])

        # Adding field 'Commutersurvey.team'
        db.add_column(u'survey_commutersurvey', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Team'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Team'
        db.delete_table(u'survey_team')

        # Deleting field 'Commutersurvey.team'
        db.delete_column(u'survey_commutersurvey', 'team_id')
