...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commutersurvey.employer'
        db.add_column(u'survey_commutersurvey', 'employer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Employer'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commutersurvey.employer'
        db.delete_column(u'survey_commutersurvey', 'employer_id')
