...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Leg.longest'
        db.delete_column(u'survey_leg', 'longest')

        # Adding field 'Leg.duration'
        db.add_column(u'survey_leg', 'duration',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Leg.longest'
        db.add_column(u'survey_leg', 'longest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Leg.duration'
        db.delete_column(u'survey_leg', 'duration')
