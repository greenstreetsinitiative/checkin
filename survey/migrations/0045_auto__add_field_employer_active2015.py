...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employer.active2015'
        db.add_column(u'survey_employer', 'active2015',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employer.active2015'
        db.delete_column(u'survey_employer', 'active2015')
